...
class AbstractProcessor {
    ...
    private static final Logger logger = LoggerFactory.getLogger(UimaProcessor)
    ...
    UimaProcessor processor
    ResourceHeader header
    Index index

    /**
     * Check if the annotations provided are acceptable for uima processing
